...
export const NUMBER_KEYS: CadKey[] = [
	...
	{ label: "−", value: "-", key: "-", code: "Minus", keyCode: 189, type: "operator" },
	...
	{ label: "/", value: "/", key: "/", code: "Slash", keyCode: 191, type: "operator" },
	{ label: "⌫", key: "Backspace", code: "Backspace", keyCode: 8, type: "action" },
];
...
export const SYMBOL_KEYS: CadKey[] = [
	...
	{ label: "(", value: "(", key: "9", code: "Digit9", keyCode: 57, modifiers: { shift: true } },
	{ label: ")", value: ")", key: "0", code: "Digit0", keyCode: 48, modifiers: { shift: true } },
	{ label: "=", value: "=", key: "=", code: "Equal", keyCode: 187, type: "operator" },
	{ label: "_", value: "_", key: "-", code: "Minus", keyCode: 189, modifiers: { shift: true } },
	{ label: "<", value: "<", key: ",", code: "Comma", keyCode: 188, modifiers: { shift: true } },
	{ label: ">", value: ">", key: ".", code: "Period", keyCode: 190, modifiers: { shift: true } },
	{ label: "⌫", key: "Backspace", code: "Backspace", keyCode: 8, type: "action" },
	{ label: "π", value: "pi", type: "function" },
	{ label: ",", value: ",", key: ",", code: "Comma", keyCode: 188 },
	{ label: ":", value: ":", key: ";", code: "Semicolon", keyCode: 186, modifiers: { shift: true } },
	{ label: "Space", value: " ", key: " ", code: "Space", keyCode: 32, type: "action" },
];

export const COMMAND_KEYS: CadKey[] = [
	{ label: "←", key: "ArrowLeft", code: "ArrowLeft", keyCode: 37, type: "action" },
	{ label: "→", key: "ArrowRight", code: "ArrowRight", keyCode: 39, type: "action" },
